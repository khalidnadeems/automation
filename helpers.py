...
JIRA_CUSTOMFIELD_BUSINESS_BENEFIT = "customfield_12345"  # Replace with actual custom field ID

SQL_SERVER = "your_sql_server"
SQL_DB = "your_database"
TABLE_NAME = "JiraReleaseDetails"

# Patch for ResilientSession
...
def get_connection():
    conn_str = (
        ...
        f"DATABASE={SQL_DB};Trusted_Connection=yes;"
    )
...
def update_jira_fields(df):
    ...
    for _, row in df.iterrows():
        try:
            ...
            print(f"Failed to update JIRA {row['JIRA']}: {e}")
